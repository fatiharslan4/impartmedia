...
type Ping struct {
	Ok bool `boil:"ok" json:"ok" toml:"ok" yaml:"ok"`
...
var PingWhere = struct {
	...
	Ok: whereHelperbool{field: "`pings`.`ok`"},
}
...
var (
	pingAllColumns            = []string{"ok"}
	pingColumnsWithoutDefault = []string{"ok"}
	pingColumnsWithDefault    = []string{}
	pingPrimaryKeyColumns     = []string{"ok"}
)

type (
	// PingSlice is an alias for a slice of pointers to Ping.
	// This should generally be used opposed to []Ping.
	PingSlice []*Ping
...
func (q pingQuery) One(ctx context.Context, exec boil.ContextExecutor) (*Ping, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodels: failed to execute a one query for pings")
	}
...
func (q pingQuery) All(ctx context.Context, exec boil.ContextExecutor) (PingSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "dbmodels: failed to assign all query results to Ping slice")
	}
...
func (q pingQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to count pings rows")
	}
...
func (q pingQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "dbmodels: failed to check if pings exists")
	}
...
func FindPing(ctx context.Context, exec boil.ContextExecutor, ok bool, selectCols ...string) (*Ping, error) {
	pingObj := &Ping{}
	...
	query := fmt.Sprintf(
		"select %s from `pings` where `ok`=?", sel,
	)

	q := queries.Raw(query, ok)
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "dbmodels: unable to select from pings")
	}
...
func (o *Ping) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("dbmodels: no pings provided for insertion")
	}
	...
	if !cached {
		...
		if len(wl) != 0 {
			...
			cache.query = "INSERT INTO `pings` () VALUES ()%s%s"
		}

		var queryOutput, queryReturning string

		if len(cache.retMapping) != 0 {
			cache.retQuery = fmt.Sprintf("SELECT `%s` FROM `pings` WHERE %s", strings.Join(returnColumns, "`,`"), strmangle.WhereClause("`", "`", 0, pingPrimaryKeyColumns))
		}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to insert into pings")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to populate default values for pings")
	}
...
func (o *Ping) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("dbmodels: unable to update pings, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update pings row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by update for pings")
	}
...
func (q pingQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update all for pings")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to retrieve rows affected for pings")
	}
...
func (o PingSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to update all in ping slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to retrieve rows affected all in update all ping")
	}
	return rowsAff, nil
}
...
func (o *Ping) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("dbmodels: no pings provided for upsert")
	}
	...
	if !cached {
		...
		if !updateColumns.IsNone() && len(update) == 0 {
			return errors.New("dbmodels: unable to upsert pings, could not build update column list")
		}

		ret = strmangle.SetComplement(ret, nzUniques)
		cache.query = buildUpsertQueryMySQL(dialect, "`pings`", update, insert)
		cache.retQuery = fmt.Sprintf(
			"SELECT %s FROM `pings` WHERE %s",
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to upsert for pings")
	}
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to retrieve unique values for pings")
	}
...
func (o *Ping) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("dbmodels: no Ping provided for delete")
	}
	...
	sql := "DELETE FROM `pings` WHERE `ok`=?"
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete from pings")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by delete for pings")
	}
...
func (q pingQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("dbmodels: no pingQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete all from pings")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: failed to get rows affected by deleteall for pings")
	}
...
func (o PingSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "dbmodels: unable to delete all from ping slice")
	}
...
func (o *Ping) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindPing(ctx, exec, o.Ok)
	if err != nil {
		return err
	}
...
func (o *PingSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "dbmodels: unable to reload all in PingSlice")
	}
...
func PingExists(ctx context.Context, exec boil.ContextExecutor, ok bool) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `pings` where `ok`=? limit 1)"
	...
	row := exec.QueryRowContext(ctx, sql, ok)

	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "dbmodels: unable to check if pings exists")
	}
