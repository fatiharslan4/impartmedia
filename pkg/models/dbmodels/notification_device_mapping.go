...
var NotificationDeviceMappingTableColumns = struct {
	MapID          string
	ImpartWealthID string
	UserDeviceID   string
	NotifyArn      string
	...
	MapID:          "notification_device_mapping.map_id",
	ImpartWealthID: "notification_device_mapping.impart_wealth_id",
	UserDeviceID:   "notification_device_mapping.user_device_id",
	NotifyArn:      "notification_device_mapping.notify_arn",
	NotifyStatus:   "notification_device_mapping.notify_status",
}
...
type (
	...
	// This should almost always be used instead of []NotificationDeviceMapping.
...
func FindNotificationDeviceMapping(ctx context.Context, exec boil.ContextExecutor, mapID uint, selectCols ...string) (*NotificationDeviceMapping, error) {
	...
	if err = notificationDeviceMappingObj.doAfterSelectHooks(ctx, exec); err != nil {
		return notificationDeviceMappingObj, err
	}
