...
func FilterData() ([]byte, error) {
	out, err := json.Marshal(map[string]FilterEnum{
		...
		"FinancialGoals-Generational wealth or legacy": FinancialGoals_GenerationalWealth,
		"FinancialGoals-House down payment":            FinancialGoals_House,
		"FinancialGoals-Philanthropy":                  FinancialGoals_Philanthropy,
		"FinancialGoals-Retirement":                    FinancialGoals_Retirement,
		"FinancialGoals-Save for college":              FinancialGoals_SaveCollege,
