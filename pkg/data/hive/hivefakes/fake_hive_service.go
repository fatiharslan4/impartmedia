...
type FakeHiveService struct {
	...
	EditPostStub        func(context.Context, *dbmodels.Post, dbmodels.TagSlice, bool, *dbmodels.PostVideo, *dbmodels.PostURL, []models.File, []models.File) (*dbmodels.Post, error)
	...
	newPostUrlArgsForCall []struct {
		arg1 context.Context
		arg2 *dbmodels.PostURL
	}
	newPostUrlReturns struct {
		result1 *dbmodels.PostURL
		result2 error
	}
	newPostUrlReturnsOnCall map[int]struct {
		result1 *dbmodels.PostURL
		result2 error
	}
...
func (fake *FakeHiveService) EditPost(arg1 context.Context, arg2 *dbmodels.Post, arg3 dbmodels.TagSlice, arg4 bool, arg5 *dbmodels.PostVideo, arg6 *dbmodels.PostURL, arg7 []models.File, arg8 []models.File) (*dbmodels.Post, error) {
	var arg7Copy []models.File
	if arg7 != nil {
		arg7Copy = make([]models.File, len(arg7))
		copy(arg7Copy, arg7)
	}
	var arg8Copy []models.File
	if arg8 != nil {
		arg8Copy = make([]models.File, len(arg8))
		copy(arg8Copy, arg8)
	}
	...
	fake.editPostArgsForCall = append(fake.editPostArgsForCall, struct {
		...
		arg7 []models.File
		arg8 []models.File
	}{arg1, arg2, arg3, arg4, arg5, arg6, arg7Copy, arg8Copy})
	stub := fake.EditPostStub
	fakeReturns := fake.editPostReturns
	fake.recordInvocation("EditPost", []interface{}{arg1, arg2, arg3, arg4, arg5, arg6, arg7Copy, arg8Copy})
...
func (fake *FakeHiveService) EditPostCalls(stub func(context.Context, *dbmodels.Post, dbmodels.TagSlice, bool, *dbmodels.PostVideo, *dbmodels.PostURL, []models.File, []models.File) (*dbmodels.Post, error)) {
	fake.editPostMutex.Lock()
	defer fake.editPostMutex.Unlock()
	fake.EditPostStub = stub
}

func (fake *FakeHiveService) EditPostArgsForCall(i int) (context.Context, *dbmodels.Post, dbmodels.TagSlice, bool, *dbmodels.PostVideo, *dbmodels.PostURL, []models.File, []models.File) {
	fake.editPostMutex.RLock()
	defer fake.editPostMutex.RUnlock()
...
func (fake *FakeHiveService) NewPostUrl(arg1 context.Context, arg2 *dbmodels.PostURL) (*dbmodels.PostURL, error) {
	...
	fake.newPostUrlArgsForCall = append(fake.newPostUrlArgsForCall, struct {
		arg1 context.Context
		arg2 *dbmodels.PostURL
	}{arg1, arg2})
	stub := fake.NewPostUrlStub
	fakeReturns := fake.newPostUrlReturns
	fake.recordInvocation("NewPostUrl", []interface{}{arg1, arg2})
	fake.newPostUrlMutex.Unlock()
	if stub != nil {
		return stub(arg1, arg2)
	}
	if specificReturn {
...
func (fake *FakeHiveService) NewPostUrlCallCount() int {
	fake.newPostUrlMutex.RLock()
	defer fake.newPostUrlMutex.RUnlock()
	return len(fake.newPostUrlArgsForCall)
}

func (fake *FakeHiveService) NewPostUrlCalls(stub func(context.Context, *dbmodels.PostURL) (*dbmodels.PostURL, error)) {
	fake.newPostUrlMutex.Lock()
	defer fake.newPostUrlMutex.Unlock()
	fake.NewPostUrlStub = stub
}

func (fake *FakeHiveService) NewPostUrlArgsForCall(i int) (context.Context, *dbmodels.PostURL) {
	fake.newPostUrlMutex.RLock()
	defer fake.newPostUrlMutex.RUnlock()
	argsForCall := fake.newPostUrlArgsForCall[i]
	return argsForCall.arg1, argsForCall.arg2
}

func (fake *FakeHiveService) NewPostUrlReturns(result1 *dbmodels.PostURL, result2 error) {
	fake.newPostUrlMutex.Lock()
	defer fake.newPostUrlMutex.Unlock()
	fake.NewPostUrlStub = nil
	fake.newPostUrlReturns = struct {
		result1 *dbmodels.PostURL
		result2 error
	}{result1, result2}
}

func (fake *FakeHiveService) NewPostUrlReturnsOnCall(i int, result1 *dbmodels.PostURL, result2 error) {
	fake.newPostUrlMutex.Lock()
	defer fake.newPostUrlMutex.Unlock()
	fake.NewPostUrlStub = nil
	if fake.newPostUrlReturnsOnCall == nil {
		fake.newPostUrlReturnsOnCall = make(map[int]struct {
			result1 *dbmodels.PostURL
			result2 error
		})
	}
	fake.newPostUrlReturnsOnCall[i] = struct {
		result1 *dbmodels.PostURL
		result2 error
	}{result1, result2}
}
