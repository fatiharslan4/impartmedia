...
var PostReactionTableColumns = struct {
	PostID         string
	ImpartWealthID string
	Upvoted        string
	Downvoted      string
	...
	PostID:         "post_reactions.post_id",
	ImpartWealthID: "post_reactions.impart_wealth_id",
	Upvoted:        "post_reactions.upvoted",
	Downvoted:      "post_reactions.downvoted",
	Reported:       "post_reactions.reported",
	ReportedReason: "post_reactions.reported_reason",
	CreatedAt:      "post_reactions.created_at",
	UpdatedAt:      "post_reactions.updated_at",
	DeletedAt:      "post_reactions.deleted_at",
}
...
type (
	...
	// This should almost always be used instead of []PostReaction.
...
func FindPostReaction(ctx context.Context, exec boil.ContextExecutor, postID uint64, impartWealthID string, selectCols ...string) (*PostReaction, error) {
	...
	if err = postReactionObj.doAfterSelectHooks(ctx, exec); err != nil {
		return postReactionObj, err
	}
